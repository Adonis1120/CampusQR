<div class="flex h-10 w-40 items-center justify-center rounded-md text-lg bg-gradient-to-r from-white/50 hover:bg-gradient-to-l hover:from-white/50 transition-all duration-1000 group">
