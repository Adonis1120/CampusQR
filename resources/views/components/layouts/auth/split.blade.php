<x-layouts.includes.head layout="auth" />
    <div class="relative grid h-dvh flex-col items-center justify-center px-8 sm:px-0 lg:max-w-none lg:grid-cols-2 lg:px-0">
        <div class="bg-muted relative hidden h-full flex-col p-10 text-white lg:flex dark:border-r dark:border-neutral-800">
            <div class="absolute inset-0 bg-gradient-to-br from-zinc-400 to-zinc-100"></div>
            ...
            <div class="relative z-20 mt-auto">
                <blockquote class="space-y-2">
                    <flux:heading size="xl" class="text-zinc-900">&ldquo;{{ trim($message) }}&rdquo;</flux:heading>
