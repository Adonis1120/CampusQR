<div class="wrapper">
    ...
    <div class="flex gap-4">
        ...
        {{-- Student Info --}}
        <div class="card flex-1 h-full p-4">
    ...
    <div class="card">
        <flux:heading level="2" class="text-xl mb-4">Today's Attendance</flux:heading>
        ...
        <div class="space-y-3">
            @forelse($recentAttendances as $attendance)
                <div class="cards">
                    ...
                    <flux:text class="text-xs">{{ $attendance->time_in->diffForHumans() }}</flux:text>
                </div>
            @empty
